...
const termsArray = [
		...
		description: (
			<>
				<p>
					...
					the city of Catersville and State of Georgia as described in
					the Internal Revenue Code Sections 501(c)(3), 509(a)(1), and
					170(b)(1)(A)(vi The SDG Impact Fund (Tax ID# 46-2368538) is
					an IRS recognized 501(c)(3) tax-exempt public charity as
					described in the Internal Revenue Code Sections 501(c)(3),
					509(a)(1), and 170(b)(1)(A)(vi). All money and property
					transferred to The SDG Impact Fund shall be an irrevocable
					gift to the charity (the “Marketplace Offerings”). In order
					to help make the Site a secure environment for the purchase
					and sale of Marketplace Offerings, all users are required to
					accept and comply with these Terms of Use. You agree that by
					accessing the Site and/or the Marketplace Offerings, you
					...
					AND/OR THE MARKETPLACE OFFERINGS AND YOU MUST DISCONTINUE
					USE IMMEDIATELY.
				</p>
				<p>
		...
		description: (
			<>
				<p>
					...
					of the Site or the Marketplace Offerings and no Content or
		...
		description: (
			<>
				<p>
					...
					jurisdiction in which you reside; (5) you will not access
					the Site or the Marketplace Offerings through automated or
					non-human means, whether through a bot, script or otherwise;
					(6) you will not use the Site for any illegal or
					unauthorized purpose; and (7) your use of the Site or the
				...
				<p>
					You may not use the Site or the Marketplace Offerings for
					any illegal or unauthorized purpose nor may you, in the use
					of Marketplace Offerings, violate any laws. Among
					unauthorized Marketplace Offerings are the following:
					intoxicants of any sort; illegal drugs or other illegal
					products; alcoholic beverages; games of chance; and
					pornography or graphic adult content, images, or other adult
					products. Postings of any unauthorized products or content
					may result in immediate termination of your account and a
					lifetime ban from use of the Site.
				</p>
				<p>
					We are a service provider and make no representations as to
					the safety, effectiveness, adequacy, accuracy, availability,
	...
	},
	{
		...
		description: (
			<>
				...
				<ul>
					<li>Visa</li> <li>Mastercard</li> <li>American Express</li>
					<li>Discover</li> <li>Cryptocurrency</li>
				</ul>
				<p>
	...
	},
	{
		...
		description: 'All sales are final and no refund will be issued.',
	},
	{
		...
		description: (
			<>
				<p>
					...
					the Marketplace Offerings and through third-party websites.
		...
		description: (
			<>
				...
				<p>
					...
					law, the arbitration will take place in United States,
					Georgia. Except as otherwise provided herein, the Parties
				...
				<p>
					...
					the state and federal courts located in Bartow, Georgia, and
